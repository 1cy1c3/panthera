var jWidget = {
	...
	init : function() {
		this.attachStylesheet('widget.js.css');
	...
	addWidgetControls : function() {
		var jWidget = this, $ = this.jQuery, settings = this.settings;

		$(settings.widgetSelector, $(settings.columns))
				.each(
						function() {
							var thisWidgetSettings = jWidget
	...
	makeSortable : function() {
		var jWidget = this, $ = this.jQuery, settings = this.settings, $sortableItems = (function() {
			var notSortable = '';
			$(settings.widgetSelector, $(settings.columns)).each(function(i) {
				if (!jWidget.getWidgetSettings(this.id).movable) {
					if (!this.id) {
